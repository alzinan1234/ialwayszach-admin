...
export default function EarningSummaryChart() {
  ...
  return (
    <div className="w-full h-full p-2.5 bg-[#17191A] bg-opacity-10 border border-[#FFFFFF80] rounded-xl flex flex-col justify-start items-center gap-5">
       ...
       <div className="text-white text-base font-medium font-['Roboto']">Earning Summary</div>
          ...
          <div className="flex justify-center items-center gap-1">
            ...
            <div className="flex justify-center items-center gap-1 px-1.5 py-0.5  bg-opacity-10 rounded-3xl bg-[#4BB54B1A]">
              ...
              <div className="text-[#9BD71B] text-sm font-semibold font-['DM Sans']">9%</div>
            </div>
          </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              itemStyle={{ color: '#AAEA22' }}
              formatter={(value) => [`${value.toLocaleString()}k`, 'Revenue']}
            />
            <Bar dataKey="revenue" fill="#AAEA22" barSize={45} radius={[5, 5, 0, 0]} /> {/* Rounded top corners */}
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
